...
export function Hero(): JSX.Element {
  return (
    <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24 md:py-32">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:mt-12 sm:flex-row">
          <Link
            href="#about"
            className="rounded-lg bg-brand-primary px-6 py-3 text-base font-medium text-white transition-colors hover:bg-blue-700 sm:px-8 sm:text-lg"
          >
            Learn More
          </Link>
          <Link
            href="#contact"
            className="rounded-lg border border-gray-300 px-6 py-3 text-base font-medium text-gray-900 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-800 sm:px-8 sm:text-lg"
          >
            Get in Touch
          </Link>
        </div>
